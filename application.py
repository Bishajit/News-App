...
@application.route('/tech') #routes to the link
def Index():
...
api_req = requests.get(f"https://newsapi.org/v2/top-headlines?sources=engadget&apiKey=1ec0f2aedee24c70b1eecb0f97e30d26") #
